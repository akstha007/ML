...
iterations = 1000;   %no. of iterations for computing gradient descent
...
[logistic_theta, logistic_j_list] = llogistic_gradient_descent(x,y,m,theta,alpha,iterations);
%fprintf('\nLogistic Regression:\n')
...
logistic_hypothesis(x,logistic_theta)